...
If you want to send files via Bluetooth to a device with the Windows operating system,
you need to perform step 3 from the given list of steps on the given device:
